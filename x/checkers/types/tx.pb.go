...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "swisstackle.checkers.checkers.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "swisstackle.checkers.checkers.MsgCreateGameResponse")
}
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	0x2e, 0xcf, 0x2c, 0x2e, 0x2e, 0x49, 0x4c, 0xce, 0xce, 0x49, 0xd5, 0x83, 0x49, 0xc3, 0x19, 0x4a,
	...
	0x1c, 0xe8, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xea, 0x61, 0x40, 0x05, 0x89, 0x01, 0x00,
	0x00,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/swisstackle.checkers.checkers.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/swisstackle.checkers.checkers.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "swisstackle.checkers.checkers.Msg",
